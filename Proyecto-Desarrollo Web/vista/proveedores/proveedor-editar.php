        ...
        <div class="col-md-6 col-lg-5">
            <div class="card shadow">
                <div class="card-header bg-warning text-dark">
                    <h4 class="mb-0 text-center">Editar Proveedor</h4>
                </div>
                <div class="card-body">
                    <form action="index.php?accion=actualizarProveedor" method="POST" id="formProveedor">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="direccion" 
                                      ...
                                      rows="3"
                                      maxlength="255"
                                      placeholder="Dirección (opcional)"><?= htmlspecialchars($proveedor->direccion) ?></textarea>
                            <!-- Sin validaciones -->
                        </div>
